...
public class RayCastViewer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        fpsCam = GetComponentInChildren<Camera>(); //->as converted to multiplayer I gonna use differen   fpsCam = GameObject.FindGameObjectWithTag("CameraPlayer").GetComponent<Camera>();
    }
